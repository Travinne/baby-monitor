...
def _format_url(url, driver, ident):
    ...
    filename = urlbaby_backend.database
    ...
    if filename and filename != ":memory:":
        ...
        assert name_token, f"sqlite filename has no name token: {urlbaby_backend.database}"
...
def _sqlite_post_configure_engine(url, engine, follower_ident):
    ...
    def dispose(engine):
        ...
        filename = engine.urlbaby_backend.database
...
def _sqlite_drop_db(cfg, eng, ident):
    _drop_dbs_w_ident(eng.urlbaby_backend.database, eng.driver, ident)
...
def _reap_sqlite_dbs(url, idents):
    ...
    for ident in idents:
        for drivername in _drivernames:
            _drop_dbs_w_ident(urlbaby_backend.database, drivername, ident)
