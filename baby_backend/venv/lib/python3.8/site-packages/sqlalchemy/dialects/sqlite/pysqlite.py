...
class SQLiteDialect_pysqlite(SQLiteDialect):
    ...
    def _is_url_file_db(cls, url: URL) -> bool:
        if (urlbaby_backend.database and urlbaby_backend.database != ":memory:") and (
    ...
    def create_connect_args(self, url: URL) -> ConnectArgsType:
        ...
        if pysqlite_opts.get("uri", False):
            ...
            filename: str = urlbaby_backend.database  # type: ignore[assignment]
            if uri_opts:
            ...
            filename = urlbaby_backend.database or ":memory:"
            if filename != ":memory:":
