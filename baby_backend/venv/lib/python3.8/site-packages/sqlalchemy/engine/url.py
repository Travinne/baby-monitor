...
class URL(NamedTuple):
    ...
    * :attr:`_engine.URLbaby_backend.database`: string database name
    * :attr:`_engine.URL.query`: an immutable mapping representing the query
    ...
    def render_as_string(self, hide_password: bool = True) -> str:
        ...
        if self.port is not None:
            s += ":" + str(self.port)
        if selfbaby_backend.database is not None:
            s += "/" + selfbaby_backend.database
        if self.query:
    ...
    def __eq__(self, other: Any) -> bool:
        return (
            ...
            and selfbaby_backend.database == otherbaby_backend.database
